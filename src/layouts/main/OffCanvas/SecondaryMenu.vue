<template>
  <div class="grid w-72 px-5 py-5 sm:w-64 w-60 bg-white dark:bg-gray-900">
    <nav class="space-y-6 truncate">
      <VaTabPanels v-model="activeTab">
        <template v-for="(menu, i) in MainMenuConfig" :key="i">
          <VaTabPanel>
            <!-- <PanelMenu :items="menu.items" class="dark:text-white" /> -->
            <!-- <Menubar :model="menu.items" class="dark:text-white" /> -->
            <div class="space-y-3">
