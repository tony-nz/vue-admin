    ...
    <nav class="flex flex-col items-center flex-1 space-y-4">
      ...
      >
        <template v-for="(item, i) in MainMenuConfig" :key="i">
          <VaTab
            :class="'p-1.5 inline-block fill-white focus:outline-nones transition-colors duration-200 rounded-lg dark:fill-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100 hover:fill-gray-500'"
