<template>
  <div
    class="flex-1 rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left"
  >
    <div class="w-full md:w-1/2">
      <div class="mb-10 md:mb-20 text-gray-600 font-light">
        <h1
          class="font-black font-light text-3xl lg:text-6xl text-slate-600 mb-10"
        >
          {{ translate("error.403.title") }}
        </h1>
        <p v-html="translate('error.403.description')" />
      </div>
...
import { goBack, translate } from "@tony-nz/vue-admin-core";

export default defineComponent({
  name: "403",
  components: {},
  setup() {
    return { goBack, translate };
  },
});
</script>
